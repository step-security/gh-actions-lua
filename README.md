...
Basic Lua installation: (Defaults to latest stable release, currently 5.5.0)

```yaml
- uses: step-security/gh-actions-lua@v13
```
...
Use shorthand versions: `5.1`, `5.2`, `5.3`, `5.4`, `5.5`, `luajit` to get the latest patch version.
